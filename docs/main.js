...
/* harmony import */ var _app_app_route__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../app/app.route */ "./src/app/app.route.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                _app_app_route__WEBPACK_IMPORTED_MODULE_6__["AppRouter"]
            ],
            providers: [_services_products_service__WEBPACK_IMPORTED_MODULE_12__["ProductsService"]],
...
var CheckoutComponent = /** @class */ (function () {
    function CheckoutComponent(cd, router, productService) {
        this.cd = cd;
        this.router = router;
    ...
    CheckoutComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        this.productService.getProduct().subscribe(function (result) {
            _this.itemList = result;
            _this.cd.markForCheck();
            console.log(result);
        }, function (error) {
            _this.message = "Problem in Service,Please try after sometime.";
        });
    };
    ...
    ], CheckoutComponent.prototype, "itemList", void 0);
    CheckoutComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ChangeDetectorRef"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_products_service__WEBPACK_IMPORTED_MODULE_2__["ProductsService"]])
    ], CheckoutComponent);
...
module.exports = "<div class=\"ibox-content\">\n    <div class=\"table-responsive\">\n        <table class=\"table shoping-cart-table\">\n            <tbody>\n            <tr>\n                <td class=\"desc\">\n                    <h3>\n                      <a href=\"#\" class=\"text-navy\">\n                          {{data.name}}\n                      </a>\n                    </h3>\n                    <dl>\n                        <dt>Product Description</dt>\n                        <!-- <p style=\"width: 80%\">{{data.desc}}</p> -->\n                    </dl>\n                </td>\n                <td>\n                    ${{data.price}}\n                </td>\n                <td width=\"65\">\n                    <input type=\"number\" min=\"1\" max=\"50\"  class=\"form-control\" value=\"{{data.quantity}}\" (change)=\"onQuantityChange($event)\" (keyup)=\"onQuantityChange($event)\">\n                </td>\n                <td>\n                    <h4>\n                        ${{totalAmount}}\n                    </h4>\n                </td>\n            </tr>\n            </tbody>\n        </table>\n        <div style=\"margin: 5px 10px;\"><span>{{data.desc}}</span></div>\n    </div>\n</div>"
...
var ProductComponent = /** @class */ (function () {
    function ProductComponent(cd) {
        this.cd = cd;
    }
    ProductComponent.prototype.ngOnInit = function () {
        this.totalAmount = this.data.price;
    };
    ProductComponent.prototype.onQuantityChange = function (evt) {
        //debugger;
...
var ProductsService = /** @class */ (function () {
    ...
    ProductsService.prototype.getProduct = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].api_url + "product.json");
    };
...
module.exports = __webpack_require__(/*! /Users/manojchaurasiya/jsproject/learning-git/projects/checkoutapp/src/main.ts */"./src/main.ts");
